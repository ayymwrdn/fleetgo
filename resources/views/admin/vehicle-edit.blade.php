...
@section('title', 'Edit Kendaraan - FleetGo')
...
<div class="max-w-3xl mx-auto">
    <div class="card p-6 md:p-8">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Kendaraan</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.vehicles.update', $vehicle->id) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $vehicle->name) }}" class="input" required>
                ...
                <div>
                    ...
                    <input type="text" name="brand" value="{{ old('brand', $vehicle->brand) }}" class="input">
                ...
                <div>
                    ...
                    <input type="text" name="plate_number" value="{{ old('plate_number', $vehicle->plate_number) }}" class="input" required>
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year', $vehicle->year) }}" class="input" min="2000" max="{{ date('Y') + 1 }}">
                ...
                <div>
                    ...
                    <select name="type" class="input" required>
                        <option value="people" {{ old('type', $vehicle->type) == 'people' ? 'selected' : '' }}>Angkutan Orang</option>
                        <option value="goods" {{ old('type', $vehicle->type) == 'goods' ? 'selected' : '' }}>Angkutan Barang</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="capacity" value="{{ old('capacity', $vehicle->capacity) }}" class="input" min="1">
                ...
                <div>
                    ...
                    <select name="status" class="input" required>
                        ...
                        <option value="maintenance" {{ old('status', $vehicle->status) == 'maintenance' ? 'selected' : '' }}>Perbaikan</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="fuel_consumption" value="{{ old('fuel_consumption', $vehicle->fuel_consumption) }}" class="input" step="0.01" min="0">
                ...
                <div>
                    ...
                    <input type="number" name="odometer" value="{{ old('odometer', $vehicle->odometer) }}" class="input" min="0">
                ...
                <div>
                    ...
                    <input type="date" name="last_service_date" value="{{ old('last_service_date', $vehicle->last_service_date ? \Carbon\Carbon::parse($vehicle->last_service_date)->format('Y-m-d') : '') }}" class="input">
                ...
                <div>
                    ...
                    <input type="date" name="next_service_date" value="{{ old('next_service_date', $vehicle->next_service_date ? \Carbon\Carbon::parse($vehicle->next_service_date)->format('Y-m-d') : '') }}" class="input">
                ...
                <div>
                    ...
                    <input type="date" name="insurance_expiry" value="{{ old('insurance_expiry', $vehicle->insurance_expiry ? \Carbon\Carbon::parse($vehicle->insurance_expiry)->format('Y-m-d') : '') }}" class="input">
